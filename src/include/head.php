...
<head>
    <!-- Site Title -->
    <title>James Wallis | Computer Science Student, Portsmouth University</title>
    ...
    <script async src="https://www.googletagmanager.com/gtag/js?id=UA-126215387-1"></script>
    <script>
    window.dataLayer = window.dataLayer || [];
    function gtag(){dataLayer.push(arguments);}
    gtag('js', new Date());

    gtag('config', 'UA-126215387-1');
    </script>
